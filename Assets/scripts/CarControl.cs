...
public class CarControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        this.GetComponent<Rigidbody>().drag = this.GetComponent<Rigidbody>().velocity.magnitude / 250;
        ...
        //设置换档的声音
        this.GetComponent<AudioSource>().pitch = Mathf.Abs(EngineRPM / MaxEngineRPM) + 1.0f;
        if (this.GetComponent<AudioSource>().pitch > 2.0)
        {
            this.GetComponent<AudioSource>().pitch = 2.0f;
        }
